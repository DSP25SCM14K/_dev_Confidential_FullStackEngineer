...
const phrases = [
  "Python and Go APIs with PostgreSQL tuning",
  "Svelte and React interfaces with TypeScript",
  "React Native flows with offline-first patterns",
  "Terraform modules and GitHub Actions pipelines",
  "OpenTelemetry traces tied to product latency"
];
